...
// ============================================================
  ...
  if (fsBtn) {
    ...
    fsBtn.addEventListener('click', function (e) { e.stopPropagation(); toggleXjFs(); });
    fsBtn.addEventListener('pointerup', function (e) { e.preventDefault(); e.stopPropagation(); toggleXjFs(); });
  }
